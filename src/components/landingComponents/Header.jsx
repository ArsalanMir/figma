  ...
  return (
    <header className="bg-white shadow-sm">
      <div className="container mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
        <a
          href="#"
          className="text-3xl font-bold text-yolearn-dark flex items-center space-x-0"
        >
          <span className="text-yolearn-blue">Y</span>
          <span className="text-emerald-500">o</span>
          <span className="text-yolearn-dark">Learn.ai</span>
        </a>
        ...
        <div className="hidden md:flex items-center flex-1 justify-center space-x-10">
          ...
          <div className="relative group">
            <a
              href="#"
              className="font-medium text-black hover:text-yolearn-blue flex items-center space-x-1"
            >
      ...
      {isMenuOpen && (
        <div className="md:hidden py-4 px-4 bg-gray-50 border-t">
          <nav className="flex flex-col space-y-3">
            <a
              href="#"
              className="font-medium text-gray-700 hover:text-yolearn-blue"
            >
              For Teachers
            </a>
            <a
            ...
            <a href="#" className="text-yolearn-blue font-medium">
              Login
            </a>
            <a
              href="#"
